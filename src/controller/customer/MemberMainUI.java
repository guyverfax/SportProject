...
import controller.portal.PortalUI;
...
public class MemberMainUI extends JFrame {
	...
	public MemberMainUI() {
        ...
        lblTime.setBounds(400, 30, 155, 15);
        ...
        btnAdd.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		JOptionPane.showMessageDialog(null, "按公司流程, 請先連絡客服為您新增訂單", "訊息", JOptionPane.INFORMATION_MESSAGE);
        		return ;
        	}
        });
        ...
        btnUpdate.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		JOptionPane.showMessageDialog(null, "按公司流程, 請先連絡客服為您處理訂單", "訊息", JOptionPane.INFORMATION_MESSAGE);
        		return ;
        	}
        });
