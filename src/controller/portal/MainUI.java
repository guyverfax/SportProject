...
public class MainUI extends JFrame {
	...
	public MainUI() {
        ...
        lblTitle.setBounds(20, 10, 413, 32);
        titlePanel.add(lblTitle);
        
        JLabel lblLogin = new JLabel("New label");
        lblLogin.setForeground(Color.WHITE);
        lblLogin.setFont(new Font("微軟正黑體", Font.BOLD, 11));
        lblLogin.setBounds(430, 10, 130, 15);
        titlePanel.add(lblLogin);
        lblLogin.setText("登入帳號: "+loingEmployusername);
        
        JLabel lblTime = new JLabel("New label");
        lblTime.setForeground(Color.WHITE);
        lblTime.setFont(new Font("微軟正黑體", Font.BOLD, 11));
        lblTime.setBounds(430, 30, 130, 15);
