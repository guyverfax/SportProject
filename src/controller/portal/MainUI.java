...
import controller.report.MonthChart;
...
public class MainUI extends JFrame {
	...
	public MainUI() {
        ...
        btnByEmploy.setBounds(231, 37, 112, 23);
        ...
        btnByProduct.setBounds(231, 95, 112, 23);
        ...
        btnByMember.setBounds(231, 154, 112, 23);
        reportPanel.add(btnByMember);
        
        JButton btnByMonth = new JButton("月銷售圖表");
        ...
        btnByMonth.setFont(new Font("微軟正黑體", Font.BOLD, 12));
        btnByMonth.setBounds(231, 207, 112, 23);
        reportPanel.add(btnByMonth);
