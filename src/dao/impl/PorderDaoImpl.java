...
public class PorderDaoImpl implements PorderDao {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        System.out.println(porderDao.readByPordernoAndEmployno("O2025021412000101", ""));
	...
	@Override
	public List<Porder> readByPorderno(String porderno) {
	...
	@Override
	public List<Porder> readByPordernoAndEmployno(String porderno, String employno) {
		String sql = "select * from porder where porderno = ? and employno = ?";
        List<Porder> porderList = new ArrayList<>();
        try (Connection conn = DbConnection.getDb();
             PreparedStatement pstmt = conn.prepareStatement(sql)) {
            pstmt.setString(1, porderno);
    ...
    @Override
	public Map<String, Integer> readAmountByProduct() {
    	Map<String, Integer> result = new HashMap<>();
        String sql = "SELECT productno, SUM(amount) AS total_amount FROM porder GROUP BY productno";
        ...
        try (Connection conn = DbConnection.getDb();
            ...
            while (rs.next()) {
                result.put(rs.getString("productno"), rs.getInt("total_amount"));
            }
	...
	public Map<String, Integer> readAmountByEmploy() {
    	Map<String, Integer> result = new HashMap<>();
        String sql = "SELECT employno, SUM(amount) AS total_amount FROM porder GROUP BY employno";
        ...
        try (Connection conn = DbConnection.getDb();
            ...
            while (rs.next()) {
                result.put(rs.getString("employno"), rs.getInt("total_amount"));
            }
