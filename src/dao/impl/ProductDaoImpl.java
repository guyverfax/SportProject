...
public class ProductDaoImpl implements ProductDao {
    ...
    public static void main(String[] args) {
		...
		*/
        ...
        //String[] plist=productDao.readByProductno();
        //for (String s:plist)
	...
	@Override
	public String[] readByProductnoAndProductname() {
		String[] productNoAndProductname = readAll()
				   .stream()
	               .map(product -> product.getProductno() + " - " + product.getProductname())
	               .toArray(String[]::new);
		return productNoAndProductname;
	}
